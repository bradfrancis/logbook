    ...
    <div class="col-md-10">
        <div class="col-md-7 col-md-offset-4">
            <div class="row">
                ...
                <p>Edit and delete your supervisors here.</p>
            </div>
            ...
            @foreach($supervisors as $supervisor)
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="panel-title">Supervisor</h4>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        {!! Form::model($supervisor, ['role' => 'form', 'route' => ['supervisors.update', $supervisor],
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::input('text', 'name', null, ['class' => 'form-control input-sm', 'disabled']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::input('text', 'license_no', null, ['class' => 'form-control input-sm', 'disabled']) !!}
                            </div>
                        </div>
                        {!! Form::close() !!}
